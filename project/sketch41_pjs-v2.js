var sketch = function( dom_canvas ) {
    ...
    pjs.setup = function() {
        ...
        Glutz2.$prog(gl, [vertexShader, fragmentShader])
        posBuf = Glutz2.$buf([1,1,0,-1,1,0,1,-1,0,-1,-1,0])
        pos = Glutz2.$attr("pos")
    ...
    /*
      *  WARNING : impossible d'utiliser une fonction draw() classique pour cause de conflit entre P5 et Glutz2,
    ...
    function scene(time) {
        ...
        // on peut utiliser la plupart des fonctions de ProcessingJS et ça c'est cool, mais
        // attention, l'association entre Glutz2 et ProcessingJS est très expérimentale et sans garantie ;)
        // console.log(pjs.mouseX);

    	// bind attributes to buffers
    	Glutz2.$bind(pos, posBuf, 3);

    	// set uniforms
    	Glutz2.$uni("time", time * 1e-3);
    	Glutz2.$uniV("resolution", [width,height]);
